...
<head>
    ...
    <title>LokerKU | Register User</title>
</head>
        ...
        <div class="login-right w-100 h-100">
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                    <div class="header">
                        <h1 class="login-title text-center">Register User</h1>
                    </div>
                    ...
                    <div class="login-form">
                        ...
                        <br>
                        <input type="telp" class="form-control" name="telp" placeholder="Masukkan Telp">
                        <br>
